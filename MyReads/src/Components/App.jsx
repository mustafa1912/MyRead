...
function App() {
  return (
    <div>
      ...
      <button type='button' className='btn bt-search btn-primary fw-bolder text-light'><NavLink to='/search'><i className="fa-solid fa-magnifying-glass text-light"></i></NavLink></button>
    </div>
  );
}
